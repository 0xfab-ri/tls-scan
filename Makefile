...
LDFLAGS = -L ${TS_DEPDIR}/lib -L ${TS_DEPDIR}/lib -lssl -L ${TS_DEPDIR}/lib -lcrypto -L ${TS_DEPDIR}/lib -levent -L ${TS_DEPDIR}/lib -levent_openssl $(libdep_$(shell uname -s))

libdep_Linux = -L ${TS_DEPDIR}/lib -lz -lrt -ldl
libdep_Darwin = -lz -dl
libdep_FreeBSD = -lz
